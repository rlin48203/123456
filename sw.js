...
self.addEventListener('message',event=>{if(event.data?.type==='SHOW_REMINDER'){self.registration.showNotification('📚 每日单词时间',{body:'今天的 10 个单词还在等你，来练一会儿吧！',tag:'daily-word-reminder',icon:'./icon.svg',badge:'./icon.svg',data:{url:'./'}});}});
